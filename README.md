...
- **Document Upload**: Upload PDF files for printing (up to 10MB).
...
### For Administrators
- **Inventory Management**: Maintain and update stock levels for all supplies.
...
- **Authentication**: Supabase Auth (with support for mock and production accounts).
